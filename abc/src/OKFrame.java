...
class Test extends JFrame {
    ...
    public void setView(){
        ...
        URL url=OKFrame.class.getResource("1.png");
        URL url2=OKFrame.class.getResource("2.png");
        JLabel a=new JLabel(new ImageIcon(url));
        a.setBounds(110,20,258,292);
        getContentPane().add(a);

        JLabel b=new JLabel(new ImageIcon(url2));
        b.setBounds(50,400,117,122);
        getContentPane().add(b);
        JLabel c=new JLabel(new ImageIcon(url2));
        c.setBounds(170,400,117,122);
        getContentPane().add(c);
        JLabel d=new JLabel(new ImageIcon(url2));
